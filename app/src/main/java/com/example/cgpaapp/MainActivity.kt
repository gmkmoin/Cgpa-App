            ...
            Surface(
                ...
                Column {
                    Text(
                        ...
                        text = "Previous Semester CGPA", style = TextStyle(
                            fontFamily = FontFamily(Font(R.font.poppins_medium)),
                            fontSize = 16.sp, color = Color(0xFFFFFFFF)
                        )
                    )
...
fun GradeTextField(grade: String, onValueChange: (String) -> Unit) {
    TextField(
        ...
        placeholder = { Text(text = "Enter your Grade", fontSize = 10.sp, color = Color.Black)},
...
fun CreditTextField(credit: Int?, onValueChange: (Int?) -> Unit) {
    TextField(
        ...
        placeholder = { Text(text = "Enter your Credit", fontSize = 10.sp, color = Color.Black)},
        colors = TextFieldDefaults.textFieldColors(
            focusedIndicatorColor = Color.Transparent,
            unfocusedIndicatorColor = Color.Transparent,
            containerColor = Color(0xFFD8CCED)
        ), shape = RoundedCornerShape(15.dp),
        textStyle = TextStyle(
